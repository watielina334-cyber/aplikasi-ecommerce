...
$baseURL = "http://localhost/delina_beauty/aplikasi-ecommerce/public/";
?>
...
<header class="fixed inset-x-0 top-0 z-50 bg-white shadow">
  ...
  <nav class="flex items-center justify-between h-16 px-4 lg:px-10">
    ...
    <div class="hidden lg:flex items-center space-x-4 -mr-4">
      ...
      <a href="<?= $baseURL ?>index.php?page=register" class="text-sm font-semibold text-gray-900 hover:text-pink-500">Sig In</a>
    </div>
